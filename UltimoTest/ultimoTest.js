...
contacto.addEventListener("click", () => {
    console.log("click en contacto");
        ...
        contacto.addEventListener("click", () => {
            ...
            fetch("contactos.json") // Reemplaza con la ruta correcta a tu archivo JSON
        .then((response) => response.json())
        .then((data) => {
            // Aquí puedes procesar los datos del archivo JSON
            console.log(data);

            // Mostrar los datos en un elemento HTML (por ejemplo, en un div)
            const resultadoDiv = document.getElementById("box");
            resultadoDiv.innerHTML = ""; // Limpia el contenido previo
        ...
        //         setTimeout(() => {
        //           resolve({
        //             '#ff0000': 'Optimizacion Auto',
        //             '#00ff00': 'Optimizacion Manual',
        //             '#0000ff': 'Contacto Tecnicos'
        //           })
        //         }, 1000)
        //       })
